#ifndef myNEUTAnalysis_h
#define myNEUTAnalysis_h
...
myNEUTAnalysis::~myNEUTAnalysis()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t myNEUTAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t myNEUTAnalysis::LoadTree(Long64_t entry)
{
...
void myNEUTAnalysis::Init(TTree *tree)
{
...
void myNEUTAnalysis::Show(Long64_t entry)
{
...
Int_t myNEUTAnalysis::Cut(Long64_t entry)
{
...
#endif // #ifdef myNEUTAnalysis_cxx
