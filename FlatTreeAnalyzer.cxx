...
void FlatTreeAnalyzer::Loop() {
	...
	TH1D* TrueDeltaPtPlot[NInte][NNeut]; //Find the transverse missing momentum plotted against many multiplicities and all neutrino interaction modes
	...
	for (int imult =0; imult<2; imult++){
	  TruePMissingCosThetaPlot[imult] = new TH1D(Form("TruePMissingCosThetaPlot_Neutrons%d", imult), ";cos(#theta_{#miss})", 10,-1,1);
